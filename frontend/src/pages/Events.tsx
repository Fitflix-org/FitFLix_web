  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Join exciting fitness events, workshops, and competitions in Bangalore. From beginner-friendly sessions to advanced training programs, discover your next fitness adventure with Fitflix." />
        <meta name="keywords" content="fitness events bangalore, workout workshops bangalore, fitness competitions bangalore, gym events bangalore, fitness training bangalore, wellness events bangalore" />
        <meta property="og:title" content="Fitness Events & Workshops | Fitflix" />
        <meta property="og:description" content="Join exciting fitness events, workshops, and competitions in Bangalore. From beginner-friendly sessions to advanced training programs, discover your next fitness adventure with Fitflix." />
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-6xl font-black mb-6">
                Fitness Events & Workshops
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-orange-100">
                Join exciting fitness events, workshops, and competitions in Bangalore
              </p>
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent className="p-4 bg-white">
                      ...
                      <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-orange-500 transition-colors cursor-pointer">
                        {event.title}
                      </h3>
                      ...
                      {event.responseCount !== undefined && (
                        <div className="flex items-center space-x-1 text-sm text-slate-500 mb-3">
                          ...
                          <span>
                            {event.responseCount} registered
                            {event.confirmedCount !== undefined && ` (${event.confirmedCount} confirmed)`}
                          </span>
                        </div>
                      )}
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        <Button
                          variant="ghost"
                          className="p-0 h-auto text-orange-500 hover:text-orange-600 font-semibold group-hover:translate-x-1 transition-transform"
                          onClick={() => {
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-600">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Learn from certified fitness experts and trainers</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Connect with like-minded fitness enthusiasts</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Try new workout styles and techniques</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Get exclusive access to premium fitness content</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={category} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                      {category}
                    </span>
                  ))}
                </div>
              ...
              <div className="space-y-4">
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="flex items-center gap-4 text-sm text-orange-700 mt-2">
                    <div className="flex items-center gap-1">
                      <Calendar className="h-4 w-4" />
                      <span>{formatEventDate(selectedEvent.date).date}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <Clock className="h-4 w-4" />
                  ...
                  <div className="text-sm text-orange-700 mt-1">
                    Entry Fee: {selectedEvent.entryFee === 0 || !selectedEvent.entryFee ? 'FREE' : `₹${selectedEvent.entryFee}`}
                  </div>
                </div>
